...
from pos_cash.pos_cash_function import last_k_installment_features

def pos_cash_last_k_installment(df, origin):
    groupby = origin.groupby(['SK_ID_CURR'])
    func = partial(last_k_installment_features, periods=[1, 10, 50])
